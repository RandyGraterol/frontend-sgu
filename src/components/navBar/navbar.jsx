        ...
        <div className="nombre">
          ...
          <div id="profile-container" ref={profileButtonRef}>
            <div id="not-button" style={style}>
              <a
                onClick={() => onNavClick("Notificacion")}
                href="#Notificacion"
              >
            ...
            {isProfileMenuOpen && (
              <div id="profile-menu">
                ...
                <a onClick={() => onNavClick("Perfil")} href="#perfil">
                  <h4 className="carrera">Perfil</h4>
                </a>
                <a href="#ChangePasword">
                  <h4 className="carrera">Cambiar contraseña</h4>
                </a>
                ...
                <li className={openMenus["Instituto"] ? "active" : ""}>
                  ...
                  {openMenus["Instituto"] && (
                    <ul
                      ref={(el) => {
                        if (el && window.innerWidth >= 767) {
                          el.style.height = openMenus["Instituto"]
                            ? `${el.scrollHeight}px`
                            : "0";
                        }
                      }}
                    ...
                    >
                      <li>
                        <a
                          onClick={() => onNavClick("Registro Instituto")}
                          href="#registro-instituto"
                        >
                          Registro instituto
                        </a>
                      </li>
                      <li>
                        <a
                          onClick={() => onNavClick("Registrar carreras")}
                          href="#registrar-carreras"
                        >
                          Registrar carreras
                        </a>
                      </li>
                      <li>
                        <a onClick={() => onNavClick("Pensum")} href="#pensum">
                          Pensum
                        </a>
                      </li>
                      ...
                      <li>
                        <a
                          onClick={() => onNavClick("Registrar áreas")}
                          href="#registrar-areas"
                        >
                          Registrar áreas
                        </a>
                      </li>
                      <li>
                        <a
                          onClick={() => onNavClick("Asignar sede-carrera")}
                          href="#asignar-sede-carrera"
                        >
                          Asignar sede-carrera
                        </a>
                      </li>
                      <li>
                        <a
                          onClick={() => onNavClick("Registrar autoridades")}
                          href="#registrar-autoridades"
                        >
                      ...
                      <li>
                        <a
                          onClick={() =>
                            onNavClick("Registro Tipo de Autoridad")
                          }
                          href="#tipo-autoridad"
                        >
                          Tipo de autoridad
                ...
                <li className={openMenus["Usuarios"] ? "active" : ""}>
                  ...
                  {openMenus["Usuarios"] && (
                    <ul
                      ref={(el) => {
                        if (el && window.innerWidth >= 767) {
                          el.style.height = openMenus["Usuarios"]
                            ? `${el.scrollHeight}px`
                            : "0";
                        }
                      }}
                    ...
                    >
                      <li>
                        <a
                          onClick={() => onNavClick("Registrar Usuario")}
                      ...
                      <li>
                        <a
                          onClick={() => onNavClick("Grupos de usuarios")}
                      ...
                      <li>
                        <a
                          onClick={() =>
                            onNavClick("Administración de usuarios")
                          }
                      ...
                      <li>
                        <a
                          onClick={() => onNavClick("Control de Acceso")}
                          href="#control-acceso"
                        >
                          Control de acceso
                        </a>
                ...
                <li className={openMenus["Procesos"] ? "active" : ""}>
                  ...
                  {openMenus["Procesos"] && (
                    <ul
                      ref={(el) => {
                        if (el && window.innerWidth >= 767) {
                          el.style.height = openMenus["Procesos"]
                            ? `${el.scrollHeight}px`
                            : "0";
                        }
                      }}
                    ...
                    >
                      <li>
                        <a
                          onClick={() => onNavClick("Periodo Academico")}
                          href="#registro-periodo"
                        >
                          Periodo academico
                        </a>
                      </li>
                      <li>
                        <a
                          onClick={() => onNavClick("Administrar procesos")}
                ...
                <li className={openMenus["Reportes"] ? "active" : ""}>
                  ...
                  {openMenus["Reportes"] && (
                    <ul
                      ref={(el) => {
                        if (el && window.innerWidth >= 767) {
                          el.style.height = openMenus["Reportes"]
                            ? `${el.scrollHeight}px`
                            : "0";
                        }
                      }}
              ...
              <>
                ...
                <li className={openMenus["Procesos"] ? "active" : ""}>
                  ...
                  {openMenus["Procesos"] && (
                    ...
                    >
                      <li>
                        <a onClick={() => onNavClick("Inscripcion")} href="#">
                          Inscripción
                        </a>
                      </li>
                      <li>
                        <a href="#">Consultar materias</a>
                      </li>
                    </ul>
                  )}
                </li>
                ...
                <li
                  className={
                    openMenus["Planilla de inscripción"] ? "active" : ""
                  }
                >
                  <a
                ...
                <li
                  className={
                    openMenus["Constancia de Estudios"] ? "active" : ""
                  }
                >
                  <a
                ...
                <li className={openMenus["Reportes"] ? "active" : ""}>
                  ...
                  {openMenus["Reportes"] && (
                    ...
                    >
                      ...
                      <li>
                        <a href="#">Listado de estudiantes por secciones</a>
                      </li>
                    </ul>
                  )}
                </li>
