...
import { faSync,faUser,faUserTimes,faArrowCircleRight,faUserCheck,faUserSecret,faUserShield,faEdit,faLock} from '@fortawesome/free-solid-svg-icons';
//importar particula registro de usuarios
...
const SuperAdmin = ({name,onControlAccesoClick,onClickRegisterUsuarios})=>{
const usuarios = [];
for(let x = 0; x < 10 ;x++){
usuarios.push( 
            <tr key={x}>
