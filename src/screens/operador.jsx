...
import {  faSync,faUser,faUserTimes,faArrowCircleRight,faUserCheck,faUserSecret,faUserShield,faUserCog,faUserTie,faUserGraduate,faEdit,faLock} from '@fortawesome/free-solid-svg-icons';
//importar particulas
...
const Operador = ({name,icono,onControlAccesoClick,onClickRegisterUsuarios})=>{
const usuarios = [];
for(let x = 0; x < 10 ;x++){
usuarios.push( 
            <tr key={x}>
